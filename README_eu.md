...
# Mastodon Archive Reader Lite (MARL) YunoHost-erako
...
[![Instalatu Mastodon Archive Reader Lite (MARL) YunoHost-ekin](https://install-app.yunohost.org/install-with-yunohost.svg)](https://install-app.yunohost.org/?app=marl)

*[Irakurri README hau beste hizkuntzatan.](./ALL_README.md)*

> *Pakete honek Mastodon Archive Reader Lite (MARL) YunoHost zerbitzari batean azkar eta zailtasunik gabe instalatzea ahalbidetzen dizu.*  
...
![Mastodon Archive Reader Lite (MARL)(r)en pantaila-argazkia](./doc/screenshots/marl_ynh.png)
